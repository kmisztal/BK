...
% SLIDE ID: sec08-discussion
\DiscussionFrame{Gdzie w procesie safety najłatwiej o opóźnienie?}{
  Czy największe ryzyko pojawia się przy rozpoznaniu \texttt{SAE}, przy przepisywaniu danych między systemami, czy przy follow-up? Które kroki najbardziej zależą od ludzi, a które można sensownie wesprzeć technologią?
}
